...
if selected == "👨‍💻 About Me":
    ...
    with st.form("contact_form", clear_on_submit=True):
        ...
        message = st.text_area("Your Message*", height=150, value=st.session_state.message,
        ...
        captcha_answer = st.text_input(
            ...
            value=st.session_state.captcha_answer
        )
            ...
            if errors:
                ...
                if email_sent or sheet_saved:
                    if email_sent and sheet_saved:
                        ...
                        st.success("📧 Message emailed! (Google Sheets saved)")
                    else:
